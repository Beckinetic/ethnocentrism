...
# Save Facet Plot
ggsave("../plot/perturbation_facet_plot_all_groups.png", plot = facet_all, width = 8, height = 6)
ggsave("../plot/perturbation_facet_plot_majority_groups.png", plot = facet_majority, width = 8, height = 6)
ggsave("../plot/perturbation_facet_plot_minority_groups.png", plot = facet_minority, width = 8, height = 6)
...
plot_types(average_data_gamma, "gamma", "majority", "Majority Group Averaged Over W", "../plot/perturbation_line_plot_majority_gamma.png")
plot_types(average_data_gamma, "gamma", "minority", "Minority Group Averaged Over W", "../plot/perturbation_line_plot_minority_gamma.png")
plot_types(average_data_gamma, "gamma", "all", "All Groups Averaged Over W", "../plot/perturbation_line_plot_all_gamma.png")

# Plot and save for W
plot_types(average_data_W, "W", "majority", "Majority Group Averaged Over Gamma", "../plot/perturbation_line_plot_majority_W.png")
plot_types(average_data_W, "W", "minority", "Minority Group Averaged Over Gamma", "../plot/perturbation_line_plot_minority_W.png")
plot_types(average_data_W, "W", "all", "All Groups Averaged Over Gamma", "../plot/perturbation_line_plot_all_W.png")
